...
import datetime
import time
wx_url = "https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=3183cecb-1495-42a4-b05b-9c5573862407"  # 测试机器人1号
send_message = "大家好！我是机器人"
...
def send_msg(content):
  """艾特全部，并发送指定信息"""
  data = json.dumps({"msgtype": "text", "text": {"content": content, "mentioned_mobile_list":["15521155442",'@all']}})
  # data = json.dumps({"msgtype": "text", "text": {"content": content}})
  r = requests.post(wx_url, data, auth=('Content-Type', 'application/json'))
  print(r.json)
def every_time_send_msg(interval_h=0, interval_m=0, interval_s=30, special_h="00", special_m="00", mode="special"):
  """每天指定时间发送指定消息"""
  # 设置自动执行间隔时间
